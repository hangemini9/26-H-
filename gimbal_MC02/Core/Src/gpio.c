...
void MX_GPIO_Init(void)
{
  ...
  /*
   * Desktop-safe default: keep both controlled 24 V outputs off.
   * MC02 V1.1 schematic shows PC13/PC14 driving NPN + PMOS enable stages,
   * so a high level can energize the corresponding XT30 2+2 output.
   */
  HAL_GPIO_WritePin(GPIOC,
                    POWER_24V_2_Pin|POWER_24V_1_Pin,
                    GPIO_PIN_RESET);

  /*Configure remaining GPIO pin output levels */
  HAL_GPIO_WritePin(GPIOC, POWER_5V_Pin|ACC_CS_Pin
